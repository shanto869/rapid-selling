...
const Footer = () => {
    ...
    return (
        <footer className="px-4 divide-y bg-slate-900 text-white">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Link rel="noopener noreferrer" to='/' className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <h4 to='/' className="self-center text-3xl font-semibold text-warning title-font">Rapid Reselling</h4>
                    </Link>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">© 2022 <span className='text-warning'>Rapid Reselling</span>. All rights reserved.</div>
        </footer>
    );
};
